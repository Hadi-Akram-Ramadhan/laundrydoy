...
if(isset($_POST['btn-simpan'])){
    ...
    // Check duplicate nama_paket
    $check_query = "SELECT COUNT(*) as count FROM paket WHERE nama_paket = '$nama' AND id_paket != '$id_paket'";
    $check_result = ambilsatubaris($conn, $check_query);
    
    if($check_result['count'] > 0) {
        echo "<script>alert('Nama paket sudah ada! Gunakan nama lain.');</script>";
    } else {
                ...
                <form method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_paket" class="form-control">
                            ...
                            <option value="<?= htmlspecialchars($key); ?>" selected><?= htmlspecialchars($key); ?>
                            </option>
                            <?php endif ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="outlet_id" class="form-control">
                            ...
                            <option value="<?= htmlspecialchars($outlet['id_outlet']); ?>" selected>
                                <?= htmlspecialchars($outlet['nama_outlet']); ?></option>
                            <?php endif ?>
                            <option value="<?= htmlspecialchars($outlet['id_outlet']); ?>">
                                <?= htmlspecialchars($outlet['nama_outlet']); ?></option>
                            <?php endforeach ?>
                        </select>
                    </div>
