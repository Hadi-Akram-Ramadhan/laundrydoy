...
AND paket.outlet_id = '$outlet_id' 
GROUP BY detail_transaksi.paket_id, paket.nama_paket, transaksi.tgl_pembayaran");

// Tambah check data sebelum foreach
if(!$penjualan) {
    $penjualan = array(); // Set empty array kalo null
}
?>
